...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            html.Br()
        ], id='dataBlock1', style={'backgroundColor':'red', 'float':'left', 'width':'33.33%'}),

        html.Div([
            html.Br(),
            html.H3("This will be data 2"),
            html.Br()
        ], id='dataBlock2', style={'backgroundColor':'blue', 'float':'left', 'width':'33.33%'}),

        html.Div([
            html.Br(),
            html.H3("This will be data 3"),
            html.Br()
        ], id='dataBlock3', style={'backgroundColor':'green', 'float':'left', 'width':'33.33%'})
